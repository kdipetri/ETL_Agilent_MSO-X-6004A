...
# for reference
import sys
import visa # PyVisa info @ https://urldefense.proofpoint.com/v2/url?u=http-3A__PyVisa.readthedocs.io_en_stable_&d=DwIGaQ&c=gRgGjJ3BkIsb5y6s49QqsA&r=WaY4b_RNg9kVxqHEJOskN4uGpB532--0MQsZGLeDquI&m=sZ3c_uxg2V1uez-xY72UbI8zasUvveMFR6e7DO6mViY&s=5ljbMmeLNqu2u-pP3fqiDrtp8UPY6d8MF32OUFkcJdk&e= 
import time
import struct
import numpy as np
import scipy as sp
