...
python InfiniiVision_SegmentedMemory_Waveform_and_Measurement_Grabber.py  --horizontalWindow 75 --numEvents 100 --trigCh 1 --trig -0.035 --trigSlope "NEGative" --timeoffset 0 
